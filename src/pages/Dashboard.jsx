...
function Dashboard() {
  ...
  const stockTotal = produits.reduce(
    (total, produit) =>
      total + calculerStock(produit.nom),
    0
  );
  ...
  const produitsStock = produits.map((produit) => ({
              ...
              <tbody>
                ...
                {produitsStock.map((produit) => {
                  ...
                  if (produit.stock <= 0) {
                    ...
                    produit.stock <= produit.seuilMinimum
                  ) {
              ...
              .map((entree) => (
                ...
                >
                  ...
                  <div className="activity-info">
                    ...
                    <strong>
                      Entrée de {entree.quantite} {entree.produit}
                    </strong>
              ...
              .map((sortie) => (
                ...
                >
                  ...
                  <div className="activity-info">
                    ...
                    <strong>
                      Sortie de {sortie.quantite} {sortie.produit}
                    </strong>
